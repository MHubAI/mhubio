...
@IO.Config('file_name_pattern', str, '[basename]', the="file name pattern which must match with the data organizer")
class JsonSegExporter(Module):
    ...
    def task(self, instance: Instance, in_datas: InstanceDataCollection, out_data: InstanceData) -> None:
        ...
        for in_data in in_datas:
            ...
            # construct json
            jseg.append({
                'file': DataOrganizer.resolveTarget(self.file_name_pattern, in_data),
